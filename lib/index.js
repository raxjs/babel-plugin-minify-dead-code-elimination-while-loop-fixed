        ...
        var _loop3 = function _loop3(name) {
          ...
          if (!binding.referenced && binding.kind !== "module") {
            ...
            if (binding.references === 1 && binding.kind !== "param" && binding.kind !== "module" && binding.constant) {
              ...
              // merge https://github.com/babel/minify/pull/1032/files#diff-bd218b419b2eb5f3fe938ff62e964ba1f8db598a68f52cd687e0d56b045c188e
              ...
              var isObj = function isObj(n) {
                return t.isFunction(n) || t.isObjectExpression(n) || t.isArrayExpression(n) || t.isRegExpLiteral(n);
              };
